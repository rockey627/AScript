...
namespace AScript.Nodes
{
    public abstract class TreeNode : ITreeNode
	{
		...
		public virtual async Task<EvalResult> EvalAsync(ScriptContext context, BuildOptions options, EvalControl control, CancellationToken cancellationToken = default)
		{
