...
namespace AScript.Operators
{
	...
	public class PowerAssignOperator : IFunctionEvaluator, IFunctionBuilder
	{
		...
		public void Build(FunctionBuildArgs e)
		{
			...
			var v = Expression.Call(ScriptUtils.Method_Math_Power, v1, v2);
		...
		public void Eval(FunctionEvalArgs e)
		{
			...
			else if (arg0Node is OperatorNode opNode)
			{
				if (opNode.Name == "." && opNode.Right is VariableNode opRightNode)
				{
					...
					var value = ScriptUtils.GetAndSetValue(opLeftValue, opRightNode.Name, out var type0, (m, t, v) => Math.Pow(Convert.ToDouble(v), Convert.ToDouble(arg1)));
				...
				if (opNode.Name == "[]")
				{
					...
					//// 根据obj类型处理索引器赋值
					var v = ScriptUtils.GetAndSetValue(obj, idx, v1 => Math.Pow(Convert.ToDouble(v1), Convert.ToDouble(value)));
