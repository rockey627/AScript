		...
		public void Eval(FunctionEvalArgs e)
		{
			...
			else if (arg0Node is OperatorNode opNode)
			{
				if (opNode.Name == "." && opNode.Right is VariableNode opRightNode)
				{
					...
					var value = ScriptUtils.GetAndSetValue(opLeftValue, opRightNode.Name, out var type0, (m, t, v) => Math.Pow(Convert.ToDouble(v), Convert.ToDouble(arg1)), e.Context.IsIgnoreCase() ?? false);
