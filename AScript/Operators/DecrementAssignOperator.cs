...
namespace AScript.Operators
{
	...
	/// --
	/// </summary>
	public class DecrementAssignOperator : IFunctionEvaluator, IFunctionBuilder
	{
		public static readonly DecrementAssignOperator Instance = new DecrementAssignOperator();
