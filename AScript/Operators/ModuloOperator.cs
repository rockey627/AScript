...
{
	public class ModuloOperator : IFunctionEvaluator, IFunctionBuilder
	{
		...
		public void Build(FunctionBuildArgs e)
		{
			...
			e.Result = ExpressionUtils.Modulo(left, right);
			//if (left.Type == typeof(object) || right.Type == typeof(object)
			//		|| !ScriptUtils.ConvertMaxType(ref left, ref right))
			//{
			//	e.Result = Expression.Dynamic(ExpressionUtils.Binder_Modulo, typeof(object), left, right);
			//}
			//else
			//{
			//	e.Result = Expression.Modulo(left, right);
			//}
		}
		...
		public void Eval(FunctionEvalArgs e)
		{
			if (e.Args.Count == 2)
			{
				...
				e.SetResult(ExpressionUtils.Modulo(arg0, arg1));
			}
		}
	}
}
