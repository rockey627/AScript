...
namespace AScript.Operators
{
	...
	/// 或|
	/// </summary>
	public class OrAssignOperator : IFunctionEvaluator, IFunctionBuilder
	{
		public static readonly OrAssignOperator Instance = new OrAssignOperator();
		...
		public void Build(FunctionBuildArgs e)
		{
			...
			if (left.Type == typeof(object) || right.Type == typeof(object))
			{
				...
				var addExpr = Expression.Dynamic(ExpressionUtils.Binder_Or, typeof(object), left, right);
				e.Result = Expression.Assign(left, addExpr);
			}
			else
			{
				e.Result = Expression.OrAssign(left, right);
			}
		}
