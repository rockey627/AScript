	...
	public class ModuloAssignOperator : IFunctionEvaluator, IFunctionBuilder
	{
		...
		public void Build(FunctionBuildArgs e)
		{
				...
				|| !ScriptUtils.ConvertMaxType(ref left, ref right))
			{
				...
				//var expr = Expression.Dynamic(ExpressionUtils.Binder_Modulo, typeof(object), left, right);
				var leftExpr = left;
				...
				var expr = Expression.Call(ExpressionUtils.Method_Modulo, leftExpr, right);
